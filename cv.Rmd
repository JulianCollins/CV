...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at _https://github.com/JulianCollins/cv/raw/master/juliancollins_cv.html_")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/JulianCollins/cv/raw/master/juliancollins_cv.pdf)")
}
```
